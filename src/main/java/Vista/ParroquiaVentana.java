...
import Controlador.ParroquiaControlador;
...
public class ParroquiaVentana extends javax.swing.JFrame{
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
            ...
            args[1]= this.txtHabitantes.getText();
            args[2]=this.txtSistemaVial.getText();
            args[3]= this.txtEstructura.getText();
            args[4]=this.txtHabitos.getText();
            parroquiaControl.crear(args);
    ...
    private void actualizarTabla(){
        ...
        encabezado[0]="NOMBRE";
        encabezado[1]="HABITANTES";
        encabezado[2]="SISTEMAVIAL";
        encabezado[3]="ESTRUCTURA";
        encabezado[4]="HABITOS";
        
        var datos = new Object[this.parroquiaControl.listar().size()][5];
        
        var i=0;
        for(var auto:this.parroquiaControl.listar()){
            datos[i][0]=auto.getNombre();
            datos[i][1]=auto.getHabitantes();
            datos[i][2]=auto.getSistemaVial();
            datos[i][3]=auto.getEstructura();
            datos[i][4]=auto.getHabitos();
            i++;
        }
    ...
    private ParroquiaControlador parroquiaControl = new ParroquiaControlador();
    ...
    private javax.swing.JLabel lblSistemaVial;
